...
/*	$FreeBSD: head/sys/dev/usb/wlan/if_zyd.c 298818 2016-04-29 22:14:11Z avos $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: head/sys/dev/usb/wlan/if_zyd.c 298818 2016-04-29 22:14:11Z avos $");
